...
<html lang="en">
  <head>
    ...
    <link rel="preload" href="http://127.0.0.1:8000/css/AdminFE.css" as="style">
    <link rel="stylesheet" href="http://127.0.0.1:8000/css/AdminFE.css" data-n-g="">
												...
												<div class="px-4 py-5 sm:p-6 bg-white">
													<div class="grid grid-cols-12 gap-6">
														<div class="col-span-12">
															<h1 class="text-2xl">Update Song {{$song->name}}</h1>
														</div>
														<div class="col-span-12">
															...
															<div>
																...
																<div class="mt-2">
																	<div class="flex flex-wrap items-stretch w-full relative mt-1">
																		<input type="text" value="{{ $song->name }}" class="flex-shrink flex-grow flex-auto focus:ring-indigo-500 flex-1 focus:border-indigo-500 block w-px shadow-sm sm:text-sm border-gray-300 rounded-md  " name="name">
																	</div>
																</div>
															</div>
														</div>
														<div class="col-span-12">
															<div>
																...
																<div class="mt-2">
																	<div class="flex flex-wrap items-stretch w-full relative mt-1">														
																		<input type="text" value="{{ $song->price }}" class="flex-shrink flex-grow flex-auto focus:ring-indigo-500 flex-1 focus:border-indigo-500 block w-px shadow-sm sm:text-sm border-gray-300 rounded-md rounded-l-none " name="price" >
																	</div>
																</div>
															</div>
														</div>
																...
																<div class="mt-2">
																	<div class="react-datepicker-wrapper">
																		<div class="react-datepicker__input-container">
																			<input type="text" value="{{ $song->release }}" placeholder="Select release date" class="mt-1 block w-full py-2 px-3 border border-gray-300 rounded-md shadow-sm focus:outline-none sm:text-sm bg-white focus:ring-indigo-500 focus:border-indigo-500" name="release" value="">
																		</div>
																	</div>
																</div>
															</div>
														...
														<div class="col-span-12">
															<div>
																...
																<div class="mt-2">
																	<div class="flex flex-wrap items-stretch w-full relative mt-1">
																		<input type="text" value="{{ $song->genres }}" class="flex-shrink flex-grow flex-auto focus:ring-indigo-500 flex-1 focus:border-indigo-500 block w-px shadow-sm sm:text-sm border-gray-300 rounded-md  " name="genres">
																	</div>
																</div>
															</div>
														</div>
														<div class="col-span-12">
															<div>
																...
																<div class="mt-2">
																	<div class="flex flex-wrap items-stretch w-full relative mt-1"><input value="{{ $song->instrument }}" type="text" class="flex-shrink flex-grow flex-auto focus:ring-indigo-500 flex-1 focus:border-indigo-500 block w-px shadow-sm sm:text-sm border-gray-300 rounded-md  " name="instrument">
																	</div>
																</div>
															</div>
														</div>
													...
													<div class="col-span-12">
														<div>
															...
															<div class="mt-2">
																<div class="flex flex-wrap items-stretch w-full relative mt-1">
																	<input value="{{ $song->song_url }}" type="text" class="flex-shrink flex-grow flex-auto focus:ring-indigo-500 flex-1 focus:border-indigo-500 block w-px shadow-sm sm:text-sm border-gray-300 rounded-md  " name="song_url">
																</div>
															</div>
														</div>
													</div>
